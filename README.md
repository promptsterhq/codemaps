...
codemaps impact <symbol> # reverse blast radius + affected tests (TS/JS, Python, Go, Java, Kotlin, Ruby)
...
| **Impact / Locate** (code graph, blast radius) | TypeScript/JavaScript, Python, **Go**, **Java**, **Kotlin**, **Ruby** | Real per-language indexers (TS compiler API / tree-sitter) |
